...
Bu proje, BSG (Bilgisayar Sistemleri Güvenliği) dersi kapsamında geliştirilmiştir.

---

## 📄 Lisans

Bu proje eğitim amaçlıdır. Akademik kullanım için referans verilmesi rica olunur.
